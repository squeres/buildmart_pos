...
$menuDefs = [
  ...
  'receipts'   => ['perm'=>'inventory',  'path'=>'/modules/receipts/',    'icon'=>'truck',        'key'=>'nav_receipts'],
  'acceptance' => ['perm'=>'inventory',  'path'=>'/modules/acceptance/',  'icon'=>'clipboard',    'key'=>'nav_acceptance'],
  ...
  'suppliers'  => ['perm'=>'inventory',  'path'=>'/modules/suppliers/',   'icon'=>'briefcase',    'key'=>'nav_suppliers'],
  'warehouses' => ['perm'=>'inventory',  'path'=>'/modules/warehouses/',  'icon'=>'home',         'key'=>'nav_warehouses'],
