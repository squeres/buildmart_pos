...
Auth::requireLogin();
Auth::requirePerm('inventory.writeoff');
        ...
        <div class="form-group">
          ...
          <div class="product-search-field">
            <div class="product-search-main">
              <select name="product_id" class="form-control" id="writeoffProductSel" required>
...
const writeoffProductSel = document.getElementById('writeoffProductSel');
const writeoffCameraBtn = document.getElementById('inventoryWriteoffCameraBtn');

if (writeoffCameraBtn && window.ProductCameraScanner) {
  window.ProductCameraScanner.attach(writeoffCameraBtn, {
    onDetected: async (code) => {
      ...
      if (exact) {
        writeoffProductSel.value = String(exact.id);
        writeoffProductSel.dispatchEvent(new Event('change', { bubbles: true }));
      }
    }
  });
}
